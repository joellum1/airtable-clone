...
export default function Header() {
  return (
    <header className="w-full h-[57px] flex items-center flex-none border-b border-gray-200 box-border shadow-xs z-10">
      <nav className='w-full pl-[8px] pr-[16px] flex justify-between items-center'>
        {/* Left Side */}
